...
\end{enumerate}
\hyperlink{bondingnumbers}{\beamerbutton{Individual Well Bond Numbers}}
\end{frame}
...
\label{Thanks}
    ...
    \hyperlink{FeeStateLiabilities}{\beamerbutton{Only Fee/State Plugging Liabilities}}
\end{frame}
...
\begin{frame}{Only Fee/State Well Liabilities: Low Plug Costs}
\label{FeeStateLiabilities}
\includegraphics[width=0.8\linewidth]{Figures/FeeStateLiability1.jpg}
\end{frame}
...
\vspace{-0.6cm}
\includegraphics[width=0.8\linewidth]{Figures/FeeStateMarginalLiability1.jpg}
\end{frame}

\begin{frame}{Only Fee/State Marginal/Inactive Well Liabilities: High Plug Costs}
\vspace{-0.6cm}
\includegraphics[width=0.8\linewidth]{Figures/FeeStateMarginalLiability2.jpg}
\end{frame}
