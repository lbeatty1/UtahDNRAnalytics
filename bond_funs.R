...
tier1_marginalbond_old = function(d){
  if(is.na(d)){return(NA)}
  if(d<=500){return(2500)}
  if(d>=501&d<=1000){return(5000)}
  if(d>=1001&d<=3000){return(10000)}
...
tier2_marginalbond_old = function(d){
  if(is.na(d)){return(NA)}
...
tier3_marginalbond_old = function(d){
  if(is.na(d)){return(NA)}
